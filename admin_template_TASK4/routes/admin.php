...
Route::group(['middleware' => 'admin.auth.admin:admin'], function(){
    ...
    //Baiviet
    Route::prefix('/Baiviet/Baidang')->as('Baiviet.Baidang.')->group(function(){
        Route::controller(App\Admin\Http\Controllers\Baiviet\BaivietController::class)->group(function(){
            Route::get('/add', 'create')->name('create');
            Route::get('/', 'index')->name('index');
            Route::get('/edit/{id}', 'edit')->name('edit');
            Route::put('/edit', 'update')->name('update');
    ...
    //Baiviet
    Route::prefix('/Baiviet/Danhmuc')->as('Baiviet.Danhmuc.')->group(function(){
        Route::controller(App\Admin\Http\Controllers\Danhmuc\DanhmucController::class)->group(function(){
            Route::get('/add', 'create')->name('create');
            Route::get('/', 'index')->name('index');
            Route::get('/edit/{id}', 'edit')->name('edit');
            Route::put('/edit', 'update')->name('update');
    ...
    //employee
    Route::prefix('/employee-manage')->as('employee.')->group(function(){
    ...
    Route::prefix('/search')->as('search.')->group(function () {
        Route::prefix('/select')->as('select.')->group(function () {
            ...
            Route::get('/danhmuc', [App\Admin\Http\Controllers\DanhmucSearchSelectController::class, 'selectSearch'])->name('danhmuc');
        });
    });
